...
class RescheduleAppointmentUser extends StatefulWidget {
  ...
  @override
  State<RescheduleAppointmentUser> createState() => _RescheduleAppointmentUserState();
}

class _RescheduleAppointmentUserState extends State<RescheduleAppointmentUser> {
  String _date = '';
  DateTime? selectedDate;
  String? timeSelection;
  List<DateTime> _blackoutDates = [];

  final UserDoctorController _userDoctorController = Get.find<UserDoctorController>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: Obx(
          () => RoundedButton(
            showLoader: _userDoctorController.rescheduleLoader.value,
            text: "Confirm",
            onPressed: () {
  ...
  void _rescheduleAppointment() async {
    ...
    final success = await _userDoctorController.rescheduleAppointment(
